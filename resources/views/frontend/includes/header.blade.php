    ...
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg headroom py-lg-3 px-lg-6 navbar-light navbar-theme-primary ">
        <div class="container">
            <a class="navbar-brand" href="/">
                <img class="navbar-brand-dark common" src="{{asset('img/logo-with-text.png')}}" height="50" alt="Logo light">
                <img class="navbar-brand-light common" src="{{asset('img/logo-with-text.png')}}" height="50" alt="Logo dark">
            </a>
            ...
            <div class="d-none d-lg-block">
                ...
                <a href="#" class="btn btn-outline-primary animate-up-2 mr-3"><i class="fas fa-th-large mr-2"></i> Support</a>
