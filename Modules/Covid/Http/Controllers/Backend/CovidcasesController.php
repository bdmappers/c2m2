...
namespace Modules\Covid\Http\Controllers\Backend;
...
class CovidcasesController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'COVID Cases';

        // module name
        $this->module_name = 'covidcases';

        // directory path of the module
        $this->module_path = 'covid::backend';

        // module icon
        $this->module_icon = 'fas fa-tags';

        // module model name, path
        $this->module_model = "Modules\Covid\Entities\Covidcase";
    }
